...
- current_stage: `stage-6-sidebar-go`
- status: `in_progress`
...
- `stage-6-sidebar-go`: pending dispatch, planned model `gpt-5.4-mini` (cheaper)
...
- `stage-6-sidebar-go`: temporary branch/worktree not yet created
