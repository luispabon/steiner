...
func NewModelCallFinishedEvent(turn int, model, finishReason string, toolCalls, totalTokens int, err error, durationMs int64, ttftMs int64, outputTPS float64) Event {
