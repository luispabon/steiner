...
func TestBuildContextReportIncludesCategoriesAndTotals(t *testing.T) {
	...
	snapshot := RequestContextSnapshot{
		...
		Messages: []provider.Message{
			{Role: provider.MessageRoleSystem, Content: prompt.SystemPreamble("", false).Content},
		...
		Blocks: []prompt.ContextBlock{
			{Source: prompt.ContextSourcePreamble, Content: prompt.SystemPreamble("", false).Content},
