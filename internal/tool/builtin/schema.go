...
func GrepSchema() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"output_mode":      map[string]any{"type": "string", "description": "Output format"},
			"case_insensitive": map[string]any{"type": "boolean", "description": "Case insensitive search"},
			"line_numbers":     map[string]any{"type": "boolean", "description": "Include line numbers"},
			"after_context":    map[string]any{"type": "integer", "description": "Lines after match"},
			"before_context":   map[string]any{"type": "integer", "description": "Lines before match"},
			...
			"head_limit":       map[string]any{"type": "integer", "description": "Max matches to return", "default": defaultGrepHeadLimit, "maximum": maxGrepHeadLimit},
