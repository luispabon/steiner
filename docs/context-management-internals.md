...
| 2 | Oneshot phase prompt (if applicable) | — | Yes |
| 3 | Agent definitions (global + project `AGENTS.md`) | 2048 + 8192 bytes | No |
| 4 | Project context files | 2000 bytes | No |
| 5 | Skills | 16384 bytes | No |
